                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input value="1" class="form-check-input" type="radio" name="gender" id="gender" @if ($data['gender'] == 1) checked @endif>
                                <label class="form-check-label">Laki-laki</label>
                            </div>
                            <div class="form-check">
                                <input value="0" class="form-check-input" type="radio" name="gender" id="gender" @if ($data['gender'] == 0) checked @endif>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <h5>Status Data</h5>
                            <div class="form-check">
                                <input value="1" class="form-check-input" type="radio" name="status_data" id="status_data" @if ($data['status_data'] == 1) checked @endif>
                                <label class="form-check-label">Aktif</label>
                            </div>
                            <div class="form-check">
                                <input value="0" class="form-check-input" type="radio" name="status_data" id="status_data" @if ($data['status_data'] == 0) checked @endif>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(response)
        {
          ...
          $.each(response, function(index, siswa) {
            ...
            row.append('<td><a href="{{ base_url('/dashboard/update') }}/' + siswa.nis + '" class="btn btn-primary btn-sm">edit</a></td>');
    ...
    $('#formUpdateData').submit(function(event) {
        ...
        $.ajax({
            url: '{{ site_url("dashboard/update_data") }}',
            type: 'POST',
            data: data,
            dataType: 'json',
            success: function(response) {
