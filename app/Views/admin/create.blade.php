        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control @isset($error) is-invalid @endisset" placeholder="Enter ..." id="nis">
                    </div>
                </div>
                <div class="col-sm-6">
                    <!-- text input -->
                    ...
                    <input type="text" class="form-control @isset($error) is-invalid @endisset" placeholder="Enter ..." id="nisn">
                    </div>
                </div>
                <div class="col-sm-6">
                    <!-- text input -->
