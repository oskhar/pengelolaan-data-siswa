      ...
      $.ajax({
        ...
        success: function(response)
        {
          ...
          $.each(response, function(index, siswa) {
            ...
            row.append(`<td>
              <a href="<?php echo e(base_url('/dashboard/detail')); ?>/' + siswa.nis + '" class="btn btn-info btn-sm">
                <i class="fas fa-eye"></i>
              </a>
              <a href="<?php echo e(base_url('/dashboard/update')); ?>/' + siswa.nis + '" class="btn btn-primary btn-sm">
